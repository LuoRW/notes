...
3. 等待事件触发，如用户点击了这个DOM节点时便会触发 `click` 事件类型
...
事件回调函数的【第1个参数】即所谓的事件对象，通常习惯性的将这个对象命名为 `event`、`ev` 、`ev` 。
...
- Web APIs :
 ...
 ![67604738945](./img/1676047389456.png)
...
- window对象下的属性和方法调用的时候可以省略window
 ...
 ![67604743636](./img/1676047436362.png)
...
history对象一般在实际开发中比较少用，但是会在一些OA 办公系统中见到。
 ...
 ![67604783479](./img/1676047834796.png)
...
![67604963508](./img/1676049635087.png)
...
- 过滤掉页面内容中的一些敏感词(替换)，或从字符串中获取我们想要的特定部分(提取)等 
 ...
 ![67607966636](./img/1676079666366.png)
...
表示字符的范围，定义的规则限定在某个范围，比如只能是英文字母，或者数字等等，用表示范围
 ...
 ![67608029616](./img/1676080296168.png)
...
| \S     | 匹配非空格的字符，相当于\[^\t\r\n\v\f]                       |
 ...
 ![67608037232](./img/1676080372325.png)

## 替换和修饰符

replace 替换方法，可以完成字符的替换

 ![67608043716](./img/1676080437160.png)
...
## 正则插件
 ...
 ![67608054863](./img/1676080548639.png)
...
## 判断是否有类
 ...
 ![67608061879](./img/1676080618794.png)
